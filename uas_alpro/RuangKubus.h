...
namespace uasalpro {
	...
	/// <summary>
	/// Summary for RuangKubus
	/// </summary>
	public ref class RuangKubus : public System::Windows::Forms::Form
	{
	public:
		RuangKubus(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(RuangKubus::typeid));
			...
			this->label1->Location = System::Drawing::Point(259, 214);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(95, 27);
			this->label1->TabIndex = 2;
			this->label1->Text = L"KUBUS";
			...
			this->button1->Click += gcnew System::EventHandler(this, &RuangKubus::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &RuangKubus::button2_Click);
			// 
			// label4
			// 
			...
			this->label3->Location = System::Drawing::Point(372, 442);
			...
			this->button3->Click += gcnew System::EventHandler(this, &RuangKubus::button3_Click);
			// 
			// button9
			// 
			...
			this->button9->Click += gcnew System::EventHandler(this, &RuangKubus::button9_Click);
			// 
			// label5
			// 
			...
			this->Name = L"RuangKubus";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Menghitung Volume dan Luas Permukaan Kubus";
...
#pragma endregion
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (Int32::TryParse(textBox1->Text, sisi)) {
			int lp = 6 * (sisi * sisi);
			label3->Text = Convert::ToString(lp);
			label5->Text = "";
		}
		else {
