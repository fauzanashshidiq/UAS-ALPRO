...
namespace uasalpro {
	...
	/// <summary>
	/// Summary for DatarLuasJajarGenjang
	/// </summary>
	public ref class DatarLuasJajarGenjang : public System::Windows::Forms::Form
	{
	public:
		DatarLuasJajarGenjang(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(DatarLuasJajarGenjang::typeid));
			...
			this->label3->Size = System::Drawing::Size(134, 48);
			...
			this->button1->Click += gcnew System::EventHandler(this, &DatarLuasJajarGenjang::button1_Click);
			// 
			// label4
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &DatarLuasJajarGenjang::button3_Click);
			// 
			// button9
			// 
			...
			this->button9->Click += gcnew System::EventHandler(this, &DatarLuasJajarGenjang::button9_Click);
			// 
			// label5
			// 
			...
			this->Name = L"DatarLuasJajarGenjang";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Menghitung Luas Jajar Genjang";
