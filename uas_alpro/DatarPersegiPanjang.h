...
namespace uasalpro {
	...
	/// <summary>
	/// Summary for DatarPersegiPanjang
	/// </summary>
	public ref class DatarPersegiPanjang : public System::Windows::Forms::Form
	{
	public:
		DatarPersegiPanjang(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(DatarPersegiPanjang::typeid));
			...
			this->label1->Location = System::Drawing::Point(188, 231);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(230, 27);
			this->label1->TabIndex = 2;
			this->label1->Text = L"PERSEGI PANJANG\r\n";
			...
			this->label2->Location = System::Drawing::Point(136, 306);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(149, 24);
			this->label2->TabIndex = 4;
			this->label2->Text = L"Masukkan Panjang\r\n";
			// 
			// label3
			// 
			...
			this->label3->Location = System::Drawing::Point(136, 372);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(130, 24);
			this->label3->TabIndex = 5;
			this->label3->Text = L"Masukkan Lebar";
			// 
			// textBox1
			// 
			...
			this->textBox1->Location = System::Drawing::Point(140, 335);
			...
			this->textBox2->Location = System::Drawing::Point(140, 401);
			...
			this->button1->Location = System::Drawing::Point(103, 476);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(186, 35);
			this->button1->TabIndex = 8;
			this->button1->Text = L"Hitung Luas";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &DatarPersegiPanjang::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Location = System::Drawing::Point(333, 476);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(186, 35);
			this->button2->TabIndex = 9;
			this->button2->Text = L"Hitung Keliling";
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &DatarPersegiPanjang::button2_Click);
			// 
			// label4
			// 
			...
			this->label4->Location = System::Drawing::Point(145, 522);
			...
			this->label5->Location = System::Drawing::Point(388, 522);
			...
			this->button3->Location = System::Drawing::Point(259, 569);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(107, 34);
			this->button3->TabIndex = 16;
			this->button3->Text = L"Reset";
			this->button3->UseVisualStyleBackColor = false;
			this->button3->Click += gcnew System::EventHandler(this, &DatarPersegiPanjang::button3_Click);
			// 
			// button9
			// 
			...
			this->button9->Location = System::Drawing::Point(241, 622);
			this->button9->Name = L"button9";
			this->button9->Size = System::Drawing::Size(148, 42);
			this->button9->TabIndex = 17;
			this->button9->Text = L"Kembali";
			this->button9->UseVisualStyleBackColor = false;
			this->button9->Click += gcnew System::EventHandler(this, &DatarPersegiPanjang::button9_Click);
			// 
			// label6
			// 
			...
			this->label6->Location = System::Drawing::Point(208, 672);
			...
			this->Name = L"DatarPersegiPanjang";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Menghitung Luas dan Keliling Persegi Panjang";
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		int panjang, lebar;
		if (Int32::TryParse(textBox1->Text, panjang) && Int32::TryParse(textBox2->Text, lebar)) {
			int luas = panjang * lebar;
			label4->Text = Convert::ToString(luas);
			label6->Text = "";
		}
		else {
			label6->Text = "Masukkan Panjang/Lebar!";
			label4->Text = "";
		}
	}
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (Int32::TryParse(textBox1->Text, panjang) && Int32::TryParse(textBox2->Text, lebar)) {
			...
			label5->Text = Convert::ToString(keliling);
			label6->Text = "";
		}
		else {
			label6->Text = "Masukkan Panjang/Lebar!";
