...
namespace uasalpro {
	...
	/// <summary>
	/// Summary for RuangBalok
	/// </summary>
	public ref class RuangBalok : public System::Windows::Forms::Form
	{
	public:
		RuangBalok(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(RuangBalok::typeid));
			...
			this->label1->Size = System::Drawing::Size(95, 27);
			this->label1->TabIndex = 3;
			this->label1->Text = L"BALOK";
			...
			this->label4->Text = L"Masukkan Tinggi";
			...
			this->button1->Click += gcnew System::EventHandler(this, &RuangBalok::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &RuangBalok::button2_Click);
			// 
			// label5
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &RuangBalok::button3_Click);
			// 
			// button9
			// 
			...
			this->button9->Click += gcnew System::EventHandler(this, &RuangBalok::button9_Click);
			// 
			// label7
			// 
			...
			this->Name = L"RuangBalok";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Menghitung Volume dan Luas Permukaan Balok";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (Int32::TryParse(textBox1->Text, panjang) && Int32::TryParse(textBox2->Text, lebar) && Int32::TryParse(textBox3->Text, tinggi)) {
