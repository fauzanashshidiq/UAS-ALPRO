...
#include "DatarKelilingJajarGenjang.h"
...
namespace uasalpro {
	...
	/// <summary>
	/// Summary for DatarJajarGenjang
	/// </summary>
	public ref class DatarJajarGenjang : public System::Windows::Forms::Form
	{
	public:
		DatarJajarGenjang(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(DatarJajarGenjang::typeid));
			...
			this->button1->Click += gcnew System::EventHandler(this, &DatarJajarGenjang::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &DatarJajarGenjang::button2_Click);
			// 
			// button9
			// 
			...
			this->button9->Location = System::Drawing::Point(237, 608);
			this->button9->Name = L"button9";
			this->button9->Size = System::Drawing::Size(148, 42);
			this->button9->TabIndex = 18;
			this->button9->Text = L"Kembali";
			this->button9->UseVisualStyleBackColor = false;
			this->button9->Click += gcnew System::EventHandler(this, &DatarJajarGenjang::button9_Click);
			// 
			// DatarJajarGenjang
			// 
			...
			this->Name = L"DatarJajarGenjang";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Menghitung Luas dan Keliling Jajar Genjang";
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		DatarJajarGenjang::Visible = false;
		DatarLuasJajarGenjang^ p2 = gcnew DatarLuasJajarGenjang;
		p2->ShowDialog();
		DatarJajarGenjang::Visible = true;
	}
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		DatarJajarGenjang::Visible = false;
		DatarKelilingJajarGenjang^ p2 = gcnew DatarKelilingJajarGenjang;
		p2->ShowDialog();
		DatarJajarGenjang::Visible = true;
	}
};
