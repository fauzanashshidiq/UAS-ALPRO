...
namespace uasalpro {
	...
	/// <summary>
	/// Summary for DatarLuasBelahKetupat
	/// </summary>
	public ref class DatarLuasBelahKetupat : public System::Windows::Forms::Form
	{
	public:
		DatarLuasBelahKetupat(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(DatarLuasBelahKetupat::typeid));
			...
			this->label2->Size = System::Drawing::Size(266, 24);
			this->label2->TabIndex = 8;
			this->label2->Text = L"Masukkan Panjang Diagonal 1 (d1)";
			...
			this->label3->Size = System::Drawing::Size(266, 72);
			this->label3->TabIndex = 9;
			this->label3->Text = L"Masukkan Panjang Diagonal 2 (d2)\r\n\r\n\r\n";
			...
			this->button1->Click += gcnew System::EventHandler(this, &DatarLuasBelahKetupat::button1_Click);
			// 
			// label4
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &DatarLuasBelahKetupat::button2_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &DatarLuasBelahKetupat::button3_Click);
			// 
			// label5
			// 
			...
			this->label5->Location = System::Drawing::Point(193, 637);
			...
			this->Name = L"DatarLuasBelahKetupat";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Menghitung Luas Belah Ketupat";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		int d1, d2;
		if (Int32::TryParse(textBox1->Text, d1) && Int32::TryParse(textBox2->Text, d2)) {
			double luas = 0.5 * d1 * d2;
			label4->Text = Convert::ToString(luas);
			label5->Text = "";
		}
		else {
			label5->Text = "Masukkan Panjang Diagonal!";
			label4->Text = "";
		}
	}
