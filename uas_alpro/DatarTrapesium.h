...
#include "DatarLuasTrapesium.h"
#include "DatarKelilingTrapesium.h"
...
namespace uasalpro {
	...
	/// <summary>
	/// Summary for DatarTrapesium
	/// </summary>
	public ref class DatarTrapesium : public System::Windows::Forms::Form
	{
	public:
		DatarTrapesium(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(DatarTrapesium::typeid));
			...
			this->label1->Location = System::Drawing::Point(229, 216);
			...
			this->button1->Click += gcnew System::EventHandler(this, &DatarTrapesium::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &DatarTrapesium::button2_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &DatarTrapesium::button3_Click);
			// 
			// DatarTrapesium
			// 
			...
			this->Name = L"DatarTrapesium";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Menghitung Luas dan Keliling Trapesium";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		DatarTrapesium::Visible = false;
		DatarLuasTrapesium^ p2 = gcnew DatarLuasTrapesium;
		p2->ShowDialog();
		DatarTrapesium::Visible = true;
	}
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		DatarTrapesium::Visible = false;
		DatarKelilingTrapesium^ p2 = gcnew DatarKelilingTrapesium;
		p2->ShowDialog();
		DatarTrapesium::Visible = true;
	}
