...
#include "DatarLuasSegitiga.h"
#include "DatarKelilingSegitiga.h"
...
namespace uasalpro {
	...
	/// <summary>
	/// Summary for DatarSegitiga
	/// </summary>
	public ref class DatarSegitiga : public System::Windows::Forms::Form
	{
	public:
		DatarSegitiga(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(DatarSegitiga::typeid));
			...
			this->button1->Click += gcnew System::EventHandler(this, &DatarSegitiga::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &DatarSegitiga::button2_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &DatarSegitiga::button3_Click);
			// 
			// DatarSegitiga
			// 
			...
			this->Name = L"DatarSegitiga";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Menghitung Luas dan Keliling Segitiga";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		DatarSegitiga::Visible = false;
		DatarLuasSegitiga^ p2 = gcnew DatarLuasSegitiga;
		p2->ShowDialog();
		DatarSegitiga::Visible = true;
	}
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		DatarSegitiga::Visible = false;
		DatarKelilingSegitiga^ p2 = gcnew DatarKelilingSegitiga;
		p2->ShowDialog();
		DatarSegitiga::Visible = true;
	}
