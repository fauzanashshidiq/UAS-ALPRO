...
#include "DatarLuasLayangLayang.h"
#include "DatarKelilingLayangLayang.h"
...
namespace uasalpro {
	...
	/// <summary>
	/// Summary for DatarLayangLayang
	/// </summary>
	public ref class DatarLayangLayang : public System::Windows::Forms::Form
	{
	public:
		DatarLayangLayang(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(DatarLayangLayang::typeid));
			...
			this->button1->Click += gcnew System::EventHandler(this, &DatarLayangLayang::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &DatarLayangLayang::button2_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &DatarLayangLayang::button3_Click);
			// 
			// DatarLayangLayang
			// 
			...
			this->Name = L"DatarLayangLayang";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Menghitung Luas dan Keliling Layang-Layang";
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		DatarLayangLayang::Visible = false;
		DatarLuasLayangLayang^ p2 = gcnew DatarLuasLayangLayang;
		p2->ShowDialog();
		DatarLayangLayang::Visible = true;
	}
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		DatarLayangLayang::Visible = false;
		DatarKelilingLayangLayang^ p2 = gcnew DatarKelilingLayangLayang;
		p2->ShowDialog();
		DatarLayangLayang::Visible = true;
	}
