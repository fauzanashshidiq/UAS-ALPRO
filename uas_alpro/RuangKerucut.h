...
namespace uasalpro {
	...
	/// <summary>
	/// Summary for RuangKerucut
	/// </summary>
	public ref class RuangKerucut : public System::Windows::Forms::Form
	{
	public:
		RuangKerucut(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(RuangKerucut::typeid));
			...
			this->button9->Click += gcnew System::EventHandler(this, &RuangKerucut::button9_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &RuangKerucut::button3_Click);
			// 
			// label5
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &RuangKerucut::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &RuangKerucut::button1_Click);
			// 
			// textBox2
			// 
			...
			this->label3->Text = L"Masukkan Tinggi Kerucut";
			...
			this->label1->Location = System::Drawing::Point(245, 215);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(127, 27);
			this->label1->TabIndex = 36;
			this->label1->Text = L"KERUCUT";
			...
			this->Name = L"RuangKerucut";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterScreen;
			this->Text = L"Menghitung Volume dan Luas Permukaan Kerucut";
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (Int32::TryParse(textBox1->Text, r) && Int32::TryParse(textBox2->Text, t)) {
			...
			double alas = phi * r * r;
			double selimut = phi * r * s;
			double lp = alas + selimut;
